...
if ($WindowsPhase -eq 'WinPE') {
    ...
    Write-Host -ForegroundColor Green "Start Installation (Windows 11 Pro 23H2)"
    Write-Host -ForegroundColor Red "Please do not close any windows during the entire installation."
    Write-Host -ForegroundColor Red "The installation runs automatically."
    Import-Module OSD -Force

    #Set energy at peak performance
    ...
    if ($Model -eq '20Y3001FGE') {
        #Start OSDCloud
        Start-OSDCloud -OSLanguage en-Us -OSBuild 23H2 -OSEdition Pro -OSLicense Retail -SkipODT -OSVersion 'Windows 11' -ZTI -SkipAutopilot
    ...
    if ($Model -eq 'Surface Pro 8') {
        #Start OSDCloud
        Start-OSDCloud -OSLanguage de-de -OSBuild 22H2 -OSEdition Pro -OSLicense Retail -OSVersion 'Windows 11' -ZTI -SkipAutopilot
